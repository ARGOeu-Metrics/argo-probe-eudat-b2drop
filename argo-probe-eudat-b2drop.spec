...
install -m 755 api/b2drop_api.py %{buildroot}/%{_libexecdir}/argo/probes/eudat-b2drop/api/b2drop_api.py
install -m 755 api/b2drop_api.py %{buildroot}/%{_libexecdir}/argo/probes/eudat-b2drop/api/b2drop_api.py
...
%attr(0755,root,root) /%{_libexecdir}/argo/probes/eudat-b2drop/api/b2drop_api.py
